    ...
    <body>
        ...
        <div id="contentArea">
                ...
                <div class="edit-profile-container">
                    ...
                    ?>
                    <h2>Edit Profile</h2>
                    <form id="updateProfileForm" action="../../Controller Layer/Organization/Organization Profile Process.php?org=<?php echo $orgId ?>" method="post" enctype = "multipart/form-data">
