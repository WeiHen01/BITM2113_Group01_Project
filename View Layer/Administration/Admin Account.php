    ...
    <body style="overflow-y: hidden">
        ...
        <div id="updateModel" class="modal">
            ...
            <?php 
                ...
                $sqlShow = "SELECT * FROM admin WHERE AdminEmail = '$loggedUserEmail'";
            ...
            <form id="updateProfileForm" action = "../../Controller Layer/Administration/Admin Profile Process.php?admin=<?php echo $row['AdminId']?>" method="post">
                <!-- Modal content -->
                <div class="modal-content">
                    ...
                    <div class="textbox">
                        <input type="text" name="Username" id="usernameInput" placeholder="Enter Your Username" value="<?php echo htmlspecialchars(isset($row['AdminName']) && $row['AdminName'] !== null ? $row['AdminName'] : 'New User', ENT_QUOTES, 'UTF-8'); ?>" />
                    </div>

                    <label style = "margin-left: 3%">Email</label>
                    <div class="textbox">
                        <input type="text" name="Email" id="emailInput" placeholder="Enter Your Email" value = <?php echo htmlspecialchars($row["AdminEmail"]) ?> >
                    </div>

                    <label style = "margin-left: 3%">Contact</label>
                    <div class="textbox" style = "margin-bottom: 10%">
                        <input type="text" name="Contact" id="contactInput" placeholder="Enter Your Contact" value = <?php echo $row["AdminContact"] === null ? "No phone" : htmlspecialchars($row["AdminContact"]) ?> >
                    </div>
        ...
        <div id="updateImageModel" class="modal-2">
            ...
            <form id="updateImageForm" action = "../../Controller Layer/Administration/Admin Profile Process.php?admin=<?php echo $row['AdminId']?>" method="post" enctype="multipart/form-data">
                <!-- Modal content -->
        ...
        <div id="updatePasswordModel" class="modal">
            ...
            <form id="updatePasswordForm" action = "../../Controller Layer/Admin/Admin Profile Process.php?admin=<?php echo $row['AdminId']?>" method="post">
                <!-- Modal content -->
                <div class="modal-content">
                    <!--Close button -->
            ...
            <div style = "display: flex;">
                ...
                <div class="left-container">
                    ...
                    <div class = "user-details">
                        ...
                        <strong><p style = "font-size: 25px"><b><?php echo $row["AdminName"] == null ? "New" :  $row["AdminName"]  ?></b></p></strong>
                        ...
                        <div style="display: flex; align-items: center; padding-left: 1%">
                            ...
                            <p><?php echo $row["AdminContact"] == null ? "-": $row["AdminContact"] ?></p>
                        </div>
