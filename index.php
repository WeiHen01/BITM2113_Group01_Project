...
<!DOCTYPE html>
    ...
    <body>
        ...
        <button class="button-2" onclick="window.location.href='./Register.php'", style="top: 5%; left: 89%; ">Get Started!</button>
        ...
        =========================-->
            ...
            <div class="text-body" style=" top: 200 px; left: 200px; font-size: 30px; font-weight: 600; text-align: center;">Trusted by</div>
        ...
        <div class="container" style="display: flex; flex-direction: row; align-items: center; padding: 10%;">
            <div class="text-section" style="flex: 1; padding-right: 40px;">
                ...
                <button class="button-1" onclick="window.location.href=''" style="background: none; color: #00bcd4;left: 23%; width: 150px; height: 40px;">Learn more</button>
            </div>
        ...
        <div class="container" style="display: flex; flex-direction: row; align-items: center; padding: 10%; background: #EBFDFFFF;">
            <div class="text-normal" style="top: 260%; left: 20%; font-size: 40px; text-align: center; font-weight: 700;">Leonardo da Vinci</div>
            <div class="text-normal" style="top: 270%; left: 20%; font-size: 33px; text-align: center;">"Water is the driving force of all nature."</div>
        </div>
        ...
        <div class="container" style=" top: 2769px; margin-left: 10%; width: 1176px; height: 358px; border-radius: 0px 8px 8px; background: #00BDD6FF; display: flex; align-items: center; justify-content: center; ">
            <div class="text-normal" style="top: 300%; left: 20%; width: 460px; font-family: Epilogue; font-size: 48px; line-height: 68px; font-weight: 700; color: #FFFFFFFF;">Get Started!</div>
            <div class="text-normal" style="top: 310%; left: 20%; font-size: 15px; ">Join us to unlock a world of possibilities! With<br>
            ...
            <button class="button" style="top: 330%; margin-right: 46%;" onclick="window.location.href='./Register.php'">Get Started ></button>
